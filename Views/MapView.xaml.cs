...
namespace Petmergency.Views
{
    public sealed partial class MapView : Page
    {
        ...
        private async void button_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (button == "webButton")
            {
                await Launcher.LaunchUriAsync(new Uri("http://www.petmergency.com/tr/"));
            }
            ...
            {
                await Launcher.LaunchUriAsync(new Uri("https://www.facebook.com/petmergency/"));
            }

            else if (button == "instagramButton")
            {
                await Launcher.LaunchUriAsync(new Uri("https://www.instagram.com/petmergency/?hl=tr"));
            }

            else if (button == "twitterButton")
            {
                await Launcher.LaunchUriAsync(new Uri("https://twitter.com/petmergency"));
            }
